...
def play(strategy0, strategy1, update,
    ...
    of dice to roll, the current player's score, the opponent's scorAPSchedulere, and the
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if tail_strategy(score, opponent_score) == 0:
        return 0

    if square_strategy(score, opponent_score) == 0:
        return 0
